var browserify = require('browserify'),//预模块化
  shim = require('browserify-shim'),
  chalk = require('chalk'),
  del = require('del'),//删除
  vinyPaths = require('vinyl-paths'),//管道删除路径
  gulp = require('gulp'),
...
gulp.task('build:concat',['build:del1'], function(done) {
  console.log(2);
  gulp.src('test/*.js')
  .pipe(uglify())
  .pipe(concat('all.js'))
...
gulp.task('build:del1', function(done) {
  console.log(1);
  del(['test/all.js'])
});
